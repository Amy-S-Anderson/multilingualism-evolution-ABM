...
```{r}
for(i in seq(tmax)){
# Calculate number of deaths this year based on age structure of population.
agent_census <- agent_census[which(is.na(agent_census$death_recorded)),]
turnover <- reap(agent_census, mortality_regime = CDW15)$pop_turnover
...
new_mothers <- sow_stationary(n_births = turnover, agent_census)
