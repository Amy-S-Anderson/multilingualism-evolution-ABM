...
starting_bank <- lapply(agents, assign_languages) # initial language bank, tracking all languages inherited vertically by infants in the cohort of agents
test <- update_language_bank(starting_bank, tmax = 20) # test run: 20 years of language learning
